...
INSTANCE DEF_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "oc_day_std.sgt";						};
												
INSTANCE DEF_Day_Thr	(C_MUSICTHEME_DEF)	{	file			= "oc_day_std.sgt";					};

INSTANCE DEF_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "oc_day_fgt.sgt";					};
												
// ----------------------------------------------------

INSTANCE DEF_Ngt_Std	(C_MUSICTHEME_DEF)	{	file			= "oc_ngt_std.sgt";					};

INSTANCE DEF_Ngt_Thr	(C_MUSICTHEME_DEF)	{	file			= "oc_ngt_std.sgt";					};

INSTANCE DEF_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "oc_day_fgt.sgt";					};
...
INSTANCE OC_Ngt_Std		(C_MUSICTHEME_DEF)	{	file			= "oc_ngt_std.sgt";					};

INSTANCE OC_Ngt_Thr		(C_MUSICTHEME_DEF)	{	file			= "oc_ngt_thr.sgt";					};

INSTANCE OC_Ngt_Fgt		(C_MUSICTHEME_DEF)	{	file			= "oc_ngt_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
...
instance ZOM_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "zom_day_std.sgt";					};

INSTANCE ZOM_Ngt_Thr	(C_MUSICTHEME_DEF)	{	file			= "cam_ngt_thr.sgt";					};

INSTANCE ZOM_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "cam_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};


// OOOOOOOOOOOOOOLLLLLLLLLLLLLLLDDDDDDDDDDDDDDDDD
...
INSTANCE OC_Ngt_Fgt		(C_MUSICTHEME_DEF)	{	file			= "cam_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
...
//
//
//INSTANCE IE_Day_Std		(C_MUSICTHEME_DEF)	{	file			= "default.sgt";   						};
//
//INSTANCE IE_Day_Thr		(C_MUSICTHEME_DEF)	{	file			= "default.sgt";   						};
//
//INSTANCE IE_Day_Fgt		(C_MUSICTHEME_DEF)	{	file			= "default.sgt";   						};
...
//INSTANCE DT_Day_Std		(C_MUSICTHEME_DEF)	{	file			= "ow_day_fev.sgt";						};
//INSTANCE DT_Day_Std		(C_MUSICTHEME_DEF)	{	file			= "dt_day_std.sgt";						};
INSTANCE DT_Day_Std		(C_MUSICTHEME_DEF)	{	file			= "oc_day_std.sgt";						};

INSTANCE DT_Ngt_Std		(C_MUSICTHEME_DEF)	{	file			= "oc_ngt_std.sgt";					};
