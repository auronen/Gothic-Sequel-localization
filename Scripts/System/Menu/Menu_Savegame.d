...
INSTANCE MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF) 
{
	...
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(1); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(2); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(3); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(4); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(5); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(6); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(7); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(8); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF) 
{
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(9); // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(10); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(11); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(12); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(13); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(14); // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   get_saveslot_string!(15); // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   get_loadslot_string!(1); // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   get_loadslot_string!(2); // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   get_loadslot_string!(3); // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   get_loadslot_string!(4); // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   get_loadslot_string!(5); // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   get_loadslot_string!(6); // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   get_loadslot_string!(7); // Kommentar	
...
{
	text[0]		=   "---";	
	text[1]		=   get_loadslot_string!(8); // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   get_loadslot_string!(9); // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   get_loadslot_string!(10); // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   get_loadslot_string!(11); // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   get_loadslot_string!(12); // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   get_loadslot_string!(13); // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   get_loadslot_string!(14); // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   get_loadslot_string!(15); // Kommentar	
