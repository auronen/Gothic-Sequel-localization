...
/* Special	 */
				INSTANCE LevelUp						(C_SFX_DEF) {file= "levelup.wav";					vol = 25;			};
				INSTANCE LogEntry						(C_SFX_DEF) {file= "LogEntry.wav";					vol = 80;			};
				instance Goodie							(C_SFX_DEF) {file= "goodie.wav";					vol = 80;			};				
...
/* Instrum. */	
				INSTANCE Inst_Conga01					(C_SFX_DEF) {file= "Conga_01.wav";					vol = 90;			};
				INSTANCE Inst_Conga02					(C_SFX_DEF) {file= "conga_02.wav";					vol = 90;			};
				INSTANCE Inst_Lute						(C_SFX_DEF) {file= "lute_01.wav";					vol = 40;			};
				INSTANCE Inst_Lute_A1					(C_SFX_DEF) {file= "lute_02.wav";					vol = 50;			};
				INSTANCE Inst_Lute_A2					(C_SFX_DEF) {file= "lute_03.wav";					vol = 60;			};
				INSTANCE Inst_Lute_A3					(C_SFX_DEF) {file= "lute_04.wav";					vol = 50;			};
				INSTANCE Inst_Lute_A4					(C_SFX_DEF) {file= "lute_05.wav";					vol = 40;			};
				INSTANCE Inst_Lute_A5					(C_SFX_DEF) {file= "lute_06.wav";					vol = 50;			};
				INSTANCE Inst_Lute_A6					(C_SFX_DEF) {file= "lute_07.wav";					vol = 60;			};
				INSTANCE Inst_Alarm						(C_SFX_DEF) {file= "trumpet_01.wav";				vol = 127;			};
		
/* Paper */	
				INSTANCE Map_Unfold						(C_SFX_DEF) {file= "Paperhandle.wav";				vol = 90;			};
				INSTANCE Scroll_Unfold					(C_SFX_DEF) {file= "ScrollRoll.wav";				vol = 90;			};
...
/* Forge */
				...
				INSTANCE Forge_Water					(C_SFX_DEF) {file= "coolblade.wav";					vol = 60;			};
...
/* Herbstomp */	
				INSTANCE Herb_Stomp						(C_SFX_DEF) {file= "herb_stomp01.wav";				vol = 100;			};
				INSTANCE Herb_Stomp_A1					(C_SFX_DEF) {file= "herb_stomp02.wav";				vol = 100;			};
				INSTANCE Herb_Stomp_A2					(C_SFX_DEF) {file= "herb_stomp03.wav";				vol = 100;			};
...
/* Psi-Lab */
				INSTANCE PsiLab_DrawLiquid				(C_SFX_DEF) {file= "psilab_drawliquid.wav";			vol = 60;			};
				INSTANCE PsiLab_DrawLiquid2				(C_SFX_DEF) {file= "psilab_drawliquid.wav";			vol = 60;			};
				INSTANCE PsiLab_PourLiquid				(C_SFX_DEF) {file= "psilab_pourliquid.wav";			vol = 80;			};
				INSTANCE PsiLab_Boiling					(C_SFX_DEF) {file= "psilab_boiling.wav";			vol = 60;			};
				...
				INSTANCE PsiLab_GetResult				(C_SFX_DEF) {file= "psilab_getresult.wav";			vol = 90;			};
...
/* Waterpipe */
 				INSTANCE Pipe_bubbles					(C_SFX_DEF) {file= "Smoke_bubbles.wav";				vol = 80;			};
...
/* Handsaw	*/
				INSTANCE HANDSAW		 				(C_SFX_DEF) {file= "handsaw_01.wav";				vol = 20;			};
				INSTANCE HANDSAW_A1		 				(C_SFX_DEF) {file= "handsaw_02.wav";				vol = 20;			};
				
/* Stoneworker */
				INSTANCE STONE_WORK 					(C_SFX_DEF) {file= "stone_work_01.wav";				vol = 70;			};
				INSTANCE STONE_WORK_A1 					(C_SFX_DEF) {file= "stone_work_02.wav";				vol = 70;			};
				INSTANCE STONE_WORK_A2 					(C_SFX_DEF) {file= "stone_work_03.wav";				vol = 70;			};
				INSTANCE STONE_WORK_A3 					(C_SFX_DEF) {file= "stone_work_04.wav";				vol = 70;			};	

/* Arrowcarver */
				INSTANCE ARROW_CARVE 					(C_SFX_DEF) {file= "arrow_carve_01.wav";			vol = 20;			};
				INSTANCE ARROW_CARVE_A1					(C_SFX_DEF) {file= "arrow_carve_02.wav";			vol = 20;			};
				INSTANCE ARROW_CARVE_A2					(C_SFX_DEF) {file= "arrow_carve_03.wav";			vol = 20;			};
				INSTANCE ARROW_CARVE_A3					(C_SFX_DEF) {file= "arrow_carve_04.wav";			vol = 20;			};
								
/* Melter */
				INSTANCE MELTER_DOOR1 					(C_SFX_DEF) {file= "melter_door_01.wav";			vol = 100;			};
				INSTANCE MELTER_DOOR2					(C_SFX_DEF) {file= "melter_door_02.wav";			vol = 80;			};
				INSTANCE MELTER_FIRE					(C_SFX_DEF) {file= "melter_door_03.wav";			vol = 90;			};
							
/* Bowmaker */
				INSTANCE BOWBEND 						(C_SFX_DEF) {file= "bowbend_01.wav";				vol = 50;			};
				INSTANCE BOWCLICK						(C_SFX_DEF) {file= "bowclick_01.wav";				vol = 30;			};

/* Runemaker */
				INSTANCE RUNE_CAST 						(C_SFX_DEF) {file= "runemaker_cast.wav";			vol = 40;			};
				INSTANCE RUNE_FLANGE					(C_SFX_DEF) {file= "runemaker_flange.wav";			vol = 50;			};
				INSTANCE RUNE_WINE						(C_SFX_DEF) {file= "runemaker_wine.wav";			vol = 60;			};
				INSTANCE RUNE_METAL						(C_SFX_DEF) {file= "runemaker_metal.wav";			vol = 65;			};
				INSTANCE RUNE_METAL_SHORT				(C_SFX_DEF) {file= "runemaker_metal_short.wav";		vol = 65;			};				
...
/* Misc */	
				...
				INSTANCE Couldron_Boil					(C_SFX_DEF) {file= "Couldron.wav"; 					vol = 90;			};
...
/* Misc: */	
				...
				INSTANCE MysteriousAmbience				(C_SFX_DEF) {file= "mysterious_ambience.wav";		vol = 40;			};
...
/* General */   
				INSTANCE SCRATCH     					(C_SFX_DEF) {file= "SCRATCH_01.wav";				vol = 80;			};
				INSTANCE SCRATCH_A1  					(C_SFX_DEF) {file= "SCRATCH_02.wav";				vol = 80;			};
...
/* Demon / Demonlord */	                                                                                                            		
				...
				INSTANCE DEM_DEM_Ambient    			(C_SFX_DEF) {file= "DEM_DEM_Ambient01.wav";			vol = 60;			};
				INSTANCE DEM_DEM_Ambient_A1 			(C_SFX_DEF) {file= "DEM_DEM_Ambient02.wav";			vol = 60;			};
				INSTANCE DEM_DEM_Ambient_A2 			(C_SFX_DEF) {file= "DEM_DEM_Ambient03.wav";			vol = 60;			};
				INSTANCE DEM_DEM_Ambient_A3 			(C_SFX_DEF) {file= "DEM_DEM_Ambient04.wav";			vol = 60;			};
				INSTANCE DEM_DEM_Ambient_A4 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE DEM_DEM_Ambient_A5 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE DEM_DEM_Ambient_A6 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE DEM_DEM_Ambient_A7 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE DEM_DEM_Ambient_A8 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE DEM_DEM_Ambient_A9 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE DEM_DEM_Attack 				(C_SFX_DEF) {file= "DEM_DEM_Attack01.wav";			vol = 100;			};
				INSTANCE DEM_DEM_Attack_A1 				(C_SFX_DEF) {file= "DEM_DEM_Attack02.wav";			vol = 100;			};
				INSTANCE DEM_DEM_Die 					(C_SFX_DEF) {file= "DEM_DEM_Die01.wav";				vol = 110;			};
				INSTANCE DEM_DEM_Die_A1					(C_SFX_DEF) {file= "DEM_DEM_Die02.wav";				vol = 110;			};
				INSTANCE DEM_DEM_Hurt  					(C_SFX_DEF) {file= "DEM_DEM_Hurt01.wav";			vol = 90;			};
				INSTANCE DEM_DEM_Warn 					(C_SFX_DEF) {file= "DEM_DEM_Warn01.wav";			vol = 110;			};
				INSTANCE DEM_DEM_WingFlap 				(C_SFX_DEF) {file= "DEM_DEM_Wingflap01.wav";		vol = 50;			};
				INSTANCE DEM_DEM_WingFlap_A1 			(C_SFX_DEF) {file= "DEM_DEM_Wingflap02.wav";		vol = 50;			};
				INSTANCE DEM_DEM_WingFlap_A2 			(C_SFX_DEF) {file= "DEM_DEM_Wingflap03.wav";		vol = 50;			};
...
/* Gobbo */                                                                                                             		
				...
				INSTANCE GOB_Warn	 					(C_SFX_DEF) {file= "GOB_Warn01.wav";				vol = 115;			};
				INSTANCE GOB_Warn_A1 					(C_SFX_DEF) {file= "GOB_Warn02.wav";				vol = 115;			};
				INSTANCE GOB_Warn_A2 					(C_SFX_DEF) {file= "GOB_Warn03.wav";				vol = 115;			};
				INSTANCE GOB_Warn_A3 					(C_SFX_DEF) {file= "GOB_Warn04.wav";				vol = 115;			};
...
/* Scavenger / Orcbiter */
				...
				INSTANCE SCA_Warn						(C_SFX_DEF) {file= "SCA_Warn01.wav";				vol = 95;			};
				                                                                                                        		
				INSTANCE SCA_DEM_Ambient_Short			(C_SFX_DEF) {file= "SCA_DEM_Ambient_Short01.wav";	vol = 50;			};
				INSTANCE SCA_DEM_Ambient_Short_A1		(C_SFX_DEF) {file= "SCA_DEM_Ambient_Short02.wav";	vol = 50;			};
				INSTANCE SCA_DEM_Ambient_Short_A2		(C_SFX_DEF) {file= "SCA_DEM_Ambient_Short03.wav";	vol = 50;			};
				INSTANCE SCA_DEM_Ambient_Short_A3		(C_SFX_DEF) {file= "SCA_DEM_Ambient_Short04.wav";	vol = 50;			};
				INSTANCE SCA_DEM_Ambient_Short_A4		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SCA_DEM_Ambient_Short_A5		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SCA_DEM_Ambient_Short_A6		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SCA_DEM_Ambient_Short_A7		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SCA_DEM_Attack					(C_SFX_DEF) {file= "SCA_DEM_Attack01.wav";			vol = 75;			};
				INSTANCE SCA_DEM_Attack_A1				(C_SFX_DEF) {file= "SCA_DEM_Attack02.wav";			vol = 75;			};				
				INSTANCE SCA_DEM_Die					(C_SFX_DEF) {file= "SCA_DEM_Die01.wav";				vol = 50;			};
				INSTANCE SCA_DEM_Die_A1					(C_SFX_DEF) {file= "SCA_DEM_Die02.wav";				vol = 50;			};
				INSTANCE SCA_DEM_Fly					(C_SFX_DEF) {file= "SCA_DEM_Fly01.wav";				vol = 35;			};
				INSTANCE SCA_DEM_Gacker					(C_SFX_DEF) {file= "SCA_DEM_Gacker01.wav";			vol = 75;			};
				INSTANCE SCA_DEM_Hurt					(C_SFX_DEF) {file= "SCA_DEM_Hurt01.wav";			vol = 75;			};
				INSTANCE SCA_DEM_Hurt_A1				(C_SFX_DEF) {file= "SCA_DEM_Hurt02.wav";			vol = 75;			};
				INSTANCE SCA_DEM_Hurt_A2				(C_SFX_DEF) {file= "SCA_DEM_Hurt03.wav";			vol = 75;			};
				INSTANCE SCA_DEM_Shakehead				(C_SFX_DEF) {file= "SCA_DEM_Shakehead01.wav";		vol = 75;			};
				INSTANCE SCA_DEM_SlurpDown				(C_SFX_DEF) {file= "SCA_DEM_Slurp01.wav";			vol = 75;			};
				INSTANCE SCA_DEM_Warn					(C_SFX_DEF) {file= "SCA_DEM_Warn01.wav";			vol = 95;			};
...
/* Shadowb. */	                                                                                                        		
				...
				INSTANCE SHA_DEM_Ambient 				(C_SFX_DEF) {file= "SHA_DEM_Ambient01.wav";			vol = 50;			};
				INSTANCE SHA_DEM_Ambient_A1				(C_SFX_DEF) {file= "SHA_DEM_Ambient02.wav";			vol = 50;			};
				INSTANCE SHA_DEM_Ambient_A2				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SHA_DEM_Ambient_A3				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SHA_DEM_Ambient_Short			(C_SFX_DEF) {file= "SHA_DEM_Ambient_Short01.wav";	vol = 50;			};
				INSTANCE SHA_DEM_Ambient_Short_A1		(C_SFX_DEF) {file= "SHA_DEM_Ambient_Short02.wav";	vol = 50;			};
				INSTANCE SHA_DEM_Ambient_Short_A2		(C_SFX_DEF) {file= "SHA_DEM_Ambient_Short03.wav";	vol = 50;			};
				INSTANCE SHA_DEM_Ambient_Short_A3		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SHA_DEM_Ambient_Short_A4		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SHA_DEM_Ambient_Short_A5		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SHA_DEM_Attack 				(C_SFX_DEF) {file= "SHA_DEM_Attack01.wav";			vol = 100;			};
				INSTANCE SHA_DEM_Attack_A1 				(C_SFX_DEF) {file= "SHA_DEM_Attack02.wav";			vol = 100;			};
				INSTANCE SHA_DEM_Attack_A2 				(C_SFX_DEF) {file= "SHA_DEM_Attack03.wav";			vol = 100;			};
				INSTANCE SHA_DEM_Attack_A3 				(C_SFX_DEF) {file= "SHA_DEM_Attack04.wav";			vol = 100;			};
				INSTANCE SHA_DEM_Die 					(C_SFX_DEF) {file= "SHA_DEM_Die01.wav";				vol = 127;			};
				INSTANCE SHA_DEM_Hurt 					(C_SFX_DEF) {file= "SHA_DEM_Hurt01.wav";			vol = 100;			};
				INSTANCE SHA_DEM_Hurt_A1 				(C_SFX_DEF) {file= "SHA_DEM_Hurt02.wav";			vol = 100;			};
				INSTANCE SHA_DEM_Hurt_A2 				(C_SFX_DEF) {file= "SHA_DEM_Hurt03.wav";			vol = 100;			};
				INSTANCE SHA_DEM_SnoreIn 				(C_SFX_DEF) {file= "SHA_DEM_Snorein01.wav";			vol = 60;			};		
				INSTANCE SHA_DEM_SnoreOut				(C_SFX_DEF) {file= "SHA_DEM_Snoreout01.wav";		vol = 60;			};		
				INSTANCE SHA_DEM_Warn 					(C_SFX_DEF) {file= "SHA_DEM_Warn01.wav";			vol = 127;			};		
				INSTANCE SHA_DEM_Warn_A1 				(C_SFX_DEF) {file= "SHA_DEM_Warn02.wav";			vol = 127;			};		
...
/* Skeleton */                                                                                                          		
				...
				INSTANCE SKE_Ambient_A3	 				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SKE_Ambient_A4	 				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SKE_Ambient_A5	 				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SKE_Ambient_A6	 				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
...
/* Snapper / Razor */	
				...
				INSTANCE SNA_DEM_Ambient 				(C_SFX_DEF) {file= "SNA_DEM_Ambient01.wav";			vol = 50;			};
				INSTANCE SNA_DEM_Ambient_A1 			(C_SFX_DEF) {file= "SNA_DEM_Ambient02.wav";			vol = 50;			};
				INSTANCE SNA_DEM_Ambient_A2 			(C_SFX_DEF) {file= "SNA_DEM_Ambient03.wav";			vol = 50;			};
				INSTANCE SNA_DEM_Ambient_A3 			(C_SFX_DEF) {file= "SNA_DEM_Ambient02.wav";			vol = 50;			};
				INSTANCE SNA_DEM_Ambient_A4 			(C_SFX_DEF) {file= "SNA_DEM_Ambient04.wav";			vol = 50;			};
				INSTANCE SNA_DEM_Ambient_A5 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_A6 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_A7 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_A8 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_A9 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_A10 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_A11 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_Short 			(C_SFX_DEF) {file= "SNA_DEM_Ambient_Short01.wav";	vol = 30;			};
				INSTANCE SNA_DEM_Ambient_Short_A1		(C_SFX_DEF) {file= "SNA_DEM_Ambient_Short02.wav";	vol = 30;			};
				INSTANCE SNA_DEM_Ambient_Short_A2		(C_SFX_DEF) {file= "SNA_DEM_Ambient_Short03.wav";	vol = 30;			};
				INSTANCE SNA_DEM_Ambient_Short_A3		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_Short_A4		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_Short_A5		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_Short_A6		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Ambient_Short_A7		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE SNA_DEM_Attack 				(C_SFX_DEF) {file= "SNA_DEM_Attack01.wav";			vol = 85;			};
				INSTANCE SNA_DEM_Attack_A1 				(C_SFX_DEF) {file= "SNA_DEM_Attack02.wav";			vol = 85;			};
				INSTANCE SNA_DEM_Clean 					(C_SFX_DEF) {file= "SNA_DEM_Clean01.wav";			vol = 100;			};
				INSTANCE SNA_DEM_Die 					(C_SFX_DEF) {file= "SNA_DEM_Die01.wav";				vol = 80;			};
				INSTANCE SNA_DEM_Happy	 				(C_SFX_DEF) {file= "SNA_DEM_Happy01.wav";			vol = 100;			};		
				INSTANCE SNA_DEM_Hurt 					(C_SFX_DEF) {file= "SNA_DEM_Hurt01.wav";			vol = 110;			};
				INSTANCE SNA_DEM_Hurt_A1 				(C_SFX_DEF) {file= "SNA_DEM_Hurt02.wav";			vol = 110;			};				
				INSTANCE SNA_DEM_Warn 					(C_SFX_DEF) {file= "SNA_DEM_Warn01.wav";			vol = 110;			};
				INSTANCE SNA_DEM_Warn_A1 				(C_SFX_DEF) {file= "SNA_DEM_Warn02.wav";			vol = 110;			};		
...
/* Troll */	                                                                                                            		
				...
				INSTANCE TRO_DEM_Ambient				(C_SFX_DEF) {file= "TRO_DEM_Ambient01.wav";			vol = 110;			};
				INSTANCE TRO_DEM_Ambient_A1				(C_SFX_DEF) {file= "TRO_DEM_Ambient02.wav";			vol = 110;			};
				INSTANCE TRO_DEM_Ambient_A2				(C_SFX_DEF) {file= "TRO_DEM_Ambient03.wav";			vol = 110;			};
				INSTANCE TRO_DEM_Ambient_A3				(C_SFX_DEF) {file= "TRO_DEM_Ambient04.wav";			vol = 110;			};
				INSTANCE TRO_DEM_Ambient_A4				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE TRO_DEM_Ambient_A5				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE TRO_DEM_Ambient_A6				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE TRO_DEM_Ambient_A7				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE TRO_DEM_Attack					(C_SFX_DEF) {file= "TRO_DEM_Attack01.wav";			vol = 125;			};
				INSTANCE TRO_DEM_Die 					(C_SFX_DEF) {file= "TRO_DEM_Die01.wav";				vol = 125;			};
				INSTANCE TRO_DEM_Fistwoosh				(C_SFX_DEF) {file= "TRO_DEM_Fistwoosh01.wav";		vol = 125;			};
				INSTANCE TRO_DEM_Growl 					(C_SFX_DEF) {file= "TRO_DEM_Growl01.wav";			vol = 125;			};
				INSTANCE TRO_DEM_Growl_A1 				(C_SFX_DEF) {file= "TRO_DEM_Growl02.wav";			vol = 125;			};
				INSTANCE TRO_DEM_Hurt					(C_SFX_DEF) {file= "TRO_DEM_Hurt01.wav";			vol = 125;			};
				INSTANCE TRO_DEM_Perception 			(C_SFX_DEF) {file= "TRO_DEM_Perception01.wav";		vol = 125;			};				
				INSTANCE TRO_DEM_Snore 					(C_SFX_DEF) {file= "TRO_DEM_Snore01.wav";			vol = 125;			};
				INSTANCE TRO_DEM_StepBoom				(C_SFX_DEF) {file= "TRO_DEM_Stepboom01.wav";		vol = 125;			};
				INSTANCE TRO_DEM_StepLight				(C_SFX_DEF) {file= "TRO_DEM_Stepboom01.wav";		vol = 50;			};
				INSTANCE TRO_DEM_Warn					(C_SFX_DEF) {file= "TRO_DEM_Warn01.wav";			vol = 127;			};
...
/* Waran / Firewaran */                                                                                                             		
				...
				INSTANCE WAR_DEM_Ambient    			(C_SFX_DEF) {file= "WAR_DEM_Ambient01.wav";			vol = 100;			};
				INSTANCE WAR_DEM_Ambient_A1    			(C_SFX_DEF) {file= "WAR_DEM_Ambient02.wav";			vol = 100;			};
				INSTANCE WAR_DEM_Ambient_A2    			(C_SFX_DEF) {file= "WAR_DEM_Ambient03.wav";			vol = 100;			};
				INSTANCE WAR_DEM_Ambient_A3    			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WAR_DEM_Ambient_A4    			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WAR_DEM_Ambient_A5    			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WAR_DEM_Ambient_Short    		(C_SFX_DEF) {file= "WAR_DEM_Ambient_Short01.wav";	vol = 100;			};
				INSTANCE WAR_DEM_Ambient_Short_A1    	(C_SFX_DEF) {file= "WAR_DEM_Ambient_Short02.wav";	vol = 100;			};
				INSTANCE WAR_DEM_Ambient_Short_A2    	(C_SFX_DEF) {file= "WAR_DEM_Ambient_Short03.wav";	vol = 100;			};
				INSTANCE WAR_DEM_Ambient_Short_A3    	(C_SFX_DEF) {file= "WAR_DEM_Ambient_Short04.wav";	vol = 100;			};
				INSTANCE WAR_DEM_Ambient_Short_A4    	(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WAR_DEM_Ambient_Short_A5    	(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WAR_DEM_Ambient_Short_A6    	(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WAR_DEM_Ambient_Short_A7    	(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WAR_DEM_Attack    				(C_SFX_DEF) {file= "WAR_DEM_Attack01.wav";			vol = 100;			};
				INSTANCE WAR_DEM_Attack_A1 				(C_SFX_DEF) {file= "WAR_DEM_Attack01.wav";			vol = 100;			};
				INSTANCE WAR_DEM_Die       				(C_SFX_DEF) {file= "WAR_DEM_Die01.wav";				vol = 100;			};
				INSTANCE WAR_DEM_Hurt      				(C_SFX_DEF) {file= "WAR_DEM_Hurt01.wav";			vol = 100;			};
				INSTANCE WAR_DEM_Hurt_A1   				(C_SFX_DEF) {file= "WAR_DEM_Hurt02.wav";			vol = 100;			};
				INSTANCE WAR_DEM_Warn      				(C_SFX_DEF) {file= "WAR_DEM_Warn01.wav";			vol = 127;			};
				INSTANCE WAR_DEM_Warn_A1   				(C_SFX_DEF) {file= "WAR_DEM_Warn02.wav";			vol = 127;			};
				INSTANCE FWA_DEM_Attack    				(C_SFX_DEF) {file= "FWA_DEM_Attack01.wav";			vol = 100;			};
				INSTANCE FWA_DEM_Attack_A1 				(C_SFX_DEF) {file= "FWA_DEM_Attack01.wav";			vol = 100;			};
...
/* Wolf / Orcdog */	                                                                                                            		
				...
				INSTANCE WOL_DEM_Ambient 				(C_SFX_DEF) {file= "WOL_DEM_Ambient01.wav";			vol = 55;			};
				INSTANCE WOL_DEM_Ambient_A1 			(C_SFX_DEF) {file= "WOL_DEM_Ambient02.wav";			vol = 55;			};
				INSTANCE WOL_DEM_Ambient_A2 			(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WOL_DEM_Ambient_A3				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WOL_DEM_Ambient_A4				(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WOL_DEM_Ambient_Short 			(C_SFX_DEF) {file= "WOL_DEM_Ambient_Short01.wav";	vol = 35;			};
				INSTANCE WOL_DEM_Ambient_Short_A1 		(C_SFX_DEF) {file= "WOL_DEM_Ambient_Short02.wav";	vol = 35;			};
				INSTANCE WOL_DEM_Ambient_Short_A2 		(C_SFX_DEF) {file= "WOL_DEM_Ambient_Short03.wav";	vol = 35;			};
				INSTANCE WOL_DEM_Ambient_Short_A3 		(C_SFX_DEF) {file= "WOL_DEM_Ambient_Short04.wav";	vol = 35;			};
				INSTANCE WOL_DEM_Ambient_Short_A4 		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WOL_DEM_Ambient_Short_A5 		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WOL_DEM_Ambient_Short_A6 		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WOL_DEM_Ambient_Short_A7 		(C_SFX_DEF) {file= "nosound.wav";					vol = 0;			};
				INSTANCE WOL_DEM_Attack 				(C_SFX_DEF) {file= "WOL_DEM_Attack01.wav";			vol = 112;			};
				INSTANCE WOL_DEM_Attack_A1 				(C_SFX_DEF) {file= "WOL_DEM_Attack02.wav";			vol = 112;			};
				INSTANCE WOL_DEM_Die 					(C_SFX_DEF) {file= "WOL_DEM_Die01.wav";				vol = 120;			};
				INSTANCE WOL_DEM_Growl 					(C_SFX_DEF) {file= "WOL_DEM_Growl01.wav";			vol = 95;			};
				INSTANCE WOL_DEM_Hurt 					(C_SFX_DEF) {file= "WOL_DEM_Hurt01.wav";			vol = 55;			};
				INSTANCE WOL_DEM_Hurt_A1				(C_SFX_DEF) {file= "WOL_DEM_Hurt02.wav";			vol = 55;			};
				INSTANCE WOL_DEM_Hurt_A2				(C_SFX_DEF) {file= "WOL_DEM_Hurt03.wav";			vol = 55;			};
				INSTANCE WOL_DEM_Warn		 			(C_SFX_DEF) {file= "WOL_DEM_Warn01.wav";			vol = 85;			};
...
// Unterwasserblubberbasenklangeffektinstanzbeschreibung
				...
				INSTANCE FallIntoWater					(C_SFX_DEF) {file= "Water_FallInto.wav";			vol = 120;			};
				INSTANCE Swim							(C_SFX_DEF) {file= "Swim_Watersurface.wav";			vol = 40;			};
				INSTANCE Swim_A1						(C_SFX_DEF) {file= "Swim_Watersurface_02.wav";		vol = 40;			};
				INSTANCE Swim_A2						(C_SFX_DEF) {file= "Swim_Watersurface_03.wav";		vol = 40;			};
				INSTANCE Swim_A3						(C_SFX_DEF) {file= "Swim_Watersurface_04.wav";		vol = 40;			};
				INSTANCE SwimBack						(C_SFX_DEF) {file= "Swim_Backwards_03.wav";			vol = 40;			};
				INSTANCE SwimBack_A1					(C_SFX_DEF) {file= "Swim_Backwards_02.wav";			vol = 40;			};
				INSTANCE Swim2Hang						(C_SFX_DEF) {file= "Swim_ClimbOut.wav";				vol = 60;			};
				INSTANCE Swim2Dive						(C_SFX_DEF) {file= "Swim_DiveDown.wav";				vol = 60;			};
				INSTANCE SwimWaves						(C_SFX_DEF) {file= "Swim_Littlewaves_01.wav";		vol = 30;			};
				INSTANCE SwimWaves_A1					(C_SFX_DEF) {file= "Swim_Littlewaves_02.wav";		vol = 30;			};
				INSTANCE SwimWaves_A2					(C_SFX_DEF) {file= "Swim_Littlewaves_03.wav";		vol = 30;			};
...
/* ready */	                                                                                                                    
				INSTANCE Drawsound_ME					(C_SFX_DEF) {file= "Sword_Draw_01.wav";				vol = 15;			}; 
				INSTANCE Drawsound_ME_A1				(C_SFX_DEF) {file= "Sword_Draw_01.wav";				vol = 15;			}; 
				INSTANCE Drawsound_WO					(C_SFX_DEF) {file= "Sword_Draw_01.wav";				vol = 15;			}; 
...
//////////////////////////////////////////////////////////////////////////////
				...
				INSTANCE BowShoot						(C_SFX_DEF) {file= "Bow_Fire_01.wav";				vol = 45;			};
				INSTANCE BowReload						(C_SFX_DEF) {file= "Woosh_After_01.wav";			vol = 50;			};
				INSTANCE CrossbowShoot					(C_SFX_DEF) {file= "Bow_Fire_01.wav";				vol = 65;			};
				INSTANCE CrossbowReload	            	(C_SFX_DEF) {file= "Woosh_After_02.wav";			vol = 50;			};
...
/* MAM */	//											faust trifft auf monster/human	        		                		
				INSTANCE CS_MAM							(C_SFX_DEF)	{file= "CS_IAM_UD_FL_01.wav";			vol = 65;			};
				INSTANCE CS_MAM_A1						(C_SFX_DEF)	{file= "CS_IAM_UD_FL_02.wav";			vol = 65;			};
				INSTANCE CS_MAM_A2						(C_SFX_DEF)	{file= "CS_IAM_UD_FL_03.wav";			vol = 65;			};
...
////////////////////                                                                            			
				...
				INSTANCE ARENAHORN_01					(C_SFX_DEF) {file= "arenahorn_01.wav";				vol = 127;			};
				INSTANCE ARENAHORN_02					(C_SFX_DEF) {file= "arenahorn_02.wav";				vol = 127;			};
...
// AARGH
				INSTANCE SVM_1_AARGH					(C_SFX_DEF) {file= "svm_1_aargh_1.wav";				vol = 127;			};
				INSTANCE SVM_1_AARGH_1					(C_SFX_DEF) {file= "svm_1_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_1_AARGH_2					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_1_AARGH_3					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_1_AARGH_4					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_2_AARGH					(C_SFX_DEF) {file= "svm_2_aargh_1.wav";				vol = 127;			};				
				INSTANCE SVM_2_AARGH_1					(C_SFX_DEF) {file= "svm_2_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_2_AARGH_2					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_2_AARGH_3					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_2_AARGH_4					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_3_AARGH					(C_SFX_DEF) {file= "svm_3_aargh_1.wav";				vol = 127;			};				
				INSTANCE SVM_3_AARGH_1					(C_SFX_DEF) {file= "svm_3_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_3_AARGH_2					(C_SFX_DEF) {file= "svm_3_aargh_3.wav";				vol = 127;			};
				INSTANCE SVM_3_AARGH_3					(C_SFX_DEF) {file= "svm_3_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_3_AARGH_4					(C_SFX_DEF) {file= "svm_3_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_4_AARGH					(C_SFX_DEF) {file= "svm_4_aargh_1.wav";				vol = 127;			};
				INSTANCE SVM_4_AARGH_1					(C_SFX_DEF) {file= "svm_4_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_4_AARGH_2					(C_SFX_DEF) {file= "svm_4_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_4_AARGH_3					(C_SFX_DEF) {file= "svm_4_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_4_AARGH_4					(C_SFX_DEF) {file= "svm_4_aargh_3.wav";				vol = 127;			};				
				...
				INSTANCE SVM_9_AARGH					(C_SFX_DEF) {file= "svm_1_aargh_1.wav";				vol = 127;			};				
				INSTANCE SVM_9_AARGH_1					(C_SFX_DEF) {file= "svm_1_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_9_AARGH_2					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};
				INSTANCE SVM_9_AARGH_3					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_9_AARGH_4					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_10_AARGH					(C_SFX_DEF) {file= "svm_2_aargh_1.wav";				vol = 127;			};
				INSTANCE SVM_10_AARGH_1					(C_SFX_DEF) {file= "svm_2_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_10_AARGH_2					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_10_AARGH_3					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_10_AARGH_4					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_11_AARGH					(C_SFX_DEF) {file= "svm_3_aargh_1.wav";				vol = 127;			};				
				INSTANCE SVM_11_AARGH_1					(C_SFX_DEF) {file= "svm_3_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_11_AARGH_2					(C_SFX_DEF) {file= "svm_3_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_11_AARGH_3					(C_SFX_DEF) {file= "svm_3_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_11_AARGH_4					(C_SFX_DEF) {file= "svm_3_aargh_3.wav";				vol = 127;			};				
 
				INSTANCE SVM_12_AARGH					(C_SFX_DEF) {file= "svm_4_aargh_1.wav";				vol = 127;			};				
				INSTANCE SVM_12_AARGH_1					(C_SFX_DEF) {file= "svm_4_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_12_AARGH_2					(C_SFX_DEF) {file= "svm_4_aargh_3.wav";				vol = 127;			};
				INSTANCE SVM_12_AARGH_3					(C_SFX_DEF) {file= "svm_4_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_12_AARGH_4					(C_SFX_DEF) {file= "svm_4_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_13_AARGH					(C_SFX_DEF) {file= "svm_1_aargh_1.wav";				vol = 127;			};
				INSTANCE SVM_13_AARGH_1					(C_SFX_DEF) {file= "svm_1_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_13_AARGH_2					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_13_AARGH_3					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_13_AARGH_4					(C_SFX_DEF) {file= "svm_1_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_14_AARGH					(C_SFX_DEF) {file= "svm_2_aargh_1.wav";				vol = 127;			};				
				INSTANCE SVM_14_AARGH_1					(C_SFX_DEF) {file= "svm_2_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_14_AARGH_2					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_14_AARGH_3					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_14_AARGH_4					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				

				INSTANCE SVM_15_AARGH					(C_SFX_DEF) {file= "svm_2_aargh_1.wav";				vol = 127;			};				
				INSTANCE SVM_15_AARGH_1					(C_SFX_DEF) {file= "svm_2_aargh_2.wav";				vol = 127;			};				
				INSTANCE SVM_15_AARGH_2					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_15_AARGH_3					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};				
				INSTANCE SVM_15_AARGH_4					(C_SFX_DEF) {file= "svm_2_aargh_3.wav";				vol = 127;			};

// 	BABE				
				INSTANCE SVM_16_AARGH					(C_SFX_DEF) {file= "BAB_Hurt01.wav";				vol = 75;			};				
				INSTANCE SVM_16_AARGH_1					(C_SFX_DEF) {file= "BAB_Hurt02.wav";				vol = 75;			};				
				INSTANCE SVM_16_AARGH_2					(C_SFX_DEF) {file= "BAB_Hurt01.wav";				vol = 60;			};				
				INSTANCE SVM_16_AARGH_3					(C_SFX_DEF) {file= "BAB_Hurt02.wav";				vol = 65;			};				
				INSTANCE SVM_16_AARGH_4					(C_SFX_DEF) {file= "BAB_Hurt01.wav";				vol = 65;			};				


//	DEAD
				INSTANCE SVM_1_DEAD						(C_SFX_DEF) {file= "svm_1_dead.wav";				vol = 127;			};				
				INSTANCE SVM_2_DEAD						(C_SFX_DEF) {file= "svm_2_dead.wav";				vol = 127;			};				
				INSTANCE SVM_3_DEAD						(C_SFX_DEF) {file= "svm_3_dead.wav";				vol = 127;			};				
				INSTANCE SVM_4_DEAD						(C_SFX_DEF) {file= "svm_1_dead.wav";				vol = 127;			};				
				INSTANCE SVM_5_DEAD						(C_SFX_DEF) {file= "svm_2_dead.wav";				vol = 127;			};				
				INSTANCE SVM_6_DEAD						(C_SFX_DEF) {file= "svm_3_dead.wav";				vol = 127;			};				
				INSTANCE SVM_7_DEAD						(C_SFX_DEF) {file= "svm_1_dead.wav";				vol = 127;			};				
				INSTANCE SVM_8_DEAD						(C_SFX_DEF) {file= "svm_2_dead.wav";				vol = 127;			};				
				INSTANCE SVM_9_DEAD						(C_SFX_DEF) {file= "svm_3_dead.wav";				vol = 127;			};				
				INSTANCE SVM_10_DEAD					(C_SFX_DEF) {file= "svm_1_dead.wav";				vol = 127;			};				
				INSTANCE SVM_11_DEAD					(C_SFX_DEF) {file= "svm_2_dead.wav";				vol = 127;			};				
				INSTANCE SVM_12_DEAD					(C_SFX_DEF) {file= "svm_3_dead.wav";				vol = 127;			};				
				INSTANCE SVM_13_DEAD					(C_SFX_DEF) {file= "svm_1_dead.wav";				vol = 127;			};				
				INSTANCE SVM_14_DEAD					(C_SFX_DEF) {file= "svm_2_dead.wav";				vol = 127;			};				
				INSTANCE SVM_15_DEAD					(C_SFX_DEF) {file= "svm_2_dead.wav";				vol = 127;			};				
//	BABE
				INSTANCE SVM_16_DEAD					(C_SFX_DEF) {file= "BAB_Die01.wav";					vol = 100;			};				
...
//	BABE				
				instance SVM_16_BERZERK					(C_SFX_DEF) {file= "BAB_Hurt01.wav";				vol = 75;			};				
