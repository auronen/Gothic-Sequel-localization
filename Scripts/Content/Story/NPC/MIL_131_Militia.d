...
instance MIL_131_Militia(C_Npc)
{
	// -------- primary data --------
	name							= NAME_Militia;
...
{
	TA_Sleep(00, 00, 07, 00, "OCC_MERCS_LEFT_ROOM_BED2");
	TA_Listen(07, 00, 18, 00, "OCC_SHADOWS_CORNER");
	TA_SitCampfire(18, 00, 00, 00, "OCC_CAMPFIRE_E_2");
};

func void Rtn_snaf_131()
{
	TA_Sleep(00, 00, 07, 00, "OCC_MERCS_LEFT_ROOM_BED2");
	TA_Listen(07, 00, 18, 00, "OCC_SHADOWS_CORNER");
