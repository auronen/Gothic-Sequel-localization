...
func void ZS_Orc_Stomper_Loop()
{
	...
	_ = AI_UseMob(self, SCEMENAME_STOMPER, 1);		//Ani anwerfen
	_ = AI_UseMob(self, SCEMENAME_STOMPER, 0);		//Ani anwerfen
...
func void ZS_Orc_Stomper_End()
{
	...
	Npc_ClearAIQueue(self);
	_ = AI_UseMob(self, SCEMENAME_STOMPER, -1);		//Schluss jetzt mit dem Quatsch
};
