...
//	- ZS_AssessQuietSound
//	- B_AssessSc, wenn der wahrnehmende Nsc sich in Wachzuständen befindet
//	(ZS_GuardWP oder ZS_GuardFp)
//
...
//		-Wachen haben eine größere Beobachtungsdistanz, bei der sie das
//		Nachsehen abbrechen
//////////////////////////////////////////////////////////////////////////
...
func int ZS_ObserveIntruderWaitNeutral_Loop()
{
	...
	//JP:Wachensonderbehandlung(siehe Header)
	...
	if (((!Npc_IsInRoutine(self, ZS_GuardWP))
	&& (!Npc_IsInRoutine(self, ZS_GuardFP)))
	&& (Npc_GetDistToNpc(self, other) > HAI_DIST_OBSERVEINTRUDER))
	{
